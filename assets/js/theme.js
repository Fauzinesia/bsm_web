...
function layout_change(layout) {
  ...
  var base = typeof window !== 'undefined' && window.assetBase ? window.assetBase : './';
  var logoSrc = isDark ? base + 'assets/images/logo-dark.svg' : base + 'assets/images/logo-white.svg';
...
function layout_theme_sidebar_change(value) {
  if (value == 'true') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      var base = typeof window !== 'undefined' && window.assetBase ? window.assetBase : './';
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', base + 'assets/images/logo-dark.svg');
    }
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      var base = typeof window !== 'undefined' && window.assetBase ? window.assetBase : './';
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', base + 'assets/images/bsm.png');
    }
    var control = document.querySelector('.theme-nav-layout .btn.active');
    if (control) {
      document.querySelector('.theme-nav-layout .btn.active').classList.remove('active');
