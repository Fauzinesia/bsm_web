  ...
  if (layout !== null && layout !== '') {
    ...
    if (layout === 'horizontal') {
      ...
      if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
        document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../assets/images/bsm.png');
      }
...
document.querySelectorAll('.auth-main.v2 .img-brand').forEach((img) => {
  img.setAttribute('src', '../assets/images/bsm.png');
});

// Fallback: remove pre-loader on DOMContentLoaded to avoid prolonged blank screen
document.addEventListener('DOMContentLoaded', function () {
  var loader = document.querySelector('.loader-bg');
  if (loader) {
  ...
  // Safety timeout in case external resources delay 'load' event
  setTimeout(function () {
    var loader2 = document.querySelector('.loader-bg');
    if (loader2 && loader2.parentNode) loader2.remove();
  }, 3000);
});
