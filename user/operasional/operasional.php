...
$page_title = 'Biaya Operasional Kendaraan';
        ...
        <div class="page-header">
          <div class="page-block">
            <div class="page-header-title">
              <h5 class="mb-0 font-medium">Biaya Operasional</h5>
            </div>
            <ul class="breadcrumb">
          ...
          <div class="col-span-12">
            <div class="card">
              <div class="card-header flex justify-between items-center">
                ...
                <!-- Untuk user, tidak ada tombol tambah/edit/hapus -->
              </div>
              <div class="card-body">
                  ...
                  <table class="table table-striped align-middle">
                    ...
                    <tbody>
                      <?php if (count($operasional) === 0): ?>
                        <tr>
                          <td colspan="5" class="text-center text-muted">Belum ada data biaya operasional.</td>
                        </tr>
                      <?php else: ?>
